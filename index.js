...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
    ...
    The count variable is inside the function scope for counter1, but outside, or in the global scope, for counter2.
  
  2. Which of the two uses a closure? How can you tell?

    counter2 uses a closure-- it contains a function that references variables outside of its own scope.
  
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better? 
     
     counter1 would be preferred if the count needs to reset to 0 every time the counterMaker function is called.
